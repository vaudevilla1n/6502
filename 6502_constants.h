...
const char *instruction_name_table[INSTRUCTION_COUNT] = {
	"INVALID",
...
uint8_t instruction_opcode_table[INSTRUCTION_COUNT] = {
...
enum addressing_mode addressing_mode_opcode_table[INSTRUCTION_GROUPS][ADDR_MODE_COUNT] = {
	{
		[ADDR_MODE_IMM] = 0x00,
		[ADDR_MODE_ZERO] = 0x01,
		[ADDR_MODE_ABS] = 0x03,
...
enum instruction instruction_table[INSTRUCTION_GROUPS][INSTRUCTION_GROUP_MAX] = {
	{ INS_BIT, INS_JMP, INS_JMA, INS_STY, INS_LDY, INS_CPY, INS_CPX, INS_INVALID },
	{ INS_ORA, INS_AND, INS_EOR, INS_ADC, INS_STA, INS_LDA, INS_CMP, INS_SBC },
	{ INS_ASL, INS_ROL, INS_LSR, INS_ROR, INS_STX, INS_LDX, INS_DEC, INS_INC },
};

enum instruction special_instruction_table[256] = {
...
enum addressing_mode addressing_mode_table[INSTRUCTION_GROUPS][INSTRUCTION_GROUP_MAX] = {
	{
		ADDR_MODE_IMM,
		ADDR_MODE_ZERO,
		ADDR_MODE_INVALID,
